# 📚 Ressources — Architecture & Ingénierie logicielle

> Une curation de vidéos, articles et livres pour monter en compétence sur l'architecture
> hexagonale, le Domain-Driven Design et l'ingénierie logicielle.
  ...
  <tr>
    <td align="center" width="25%">
      <a href="LIEN_AMAZON_OU_MOMOX">
        <img src="COVER_URL" width="120" alt="Get Your Hands Dirty on Clean Architecture"><br>
        <sub><b>Get Your Hands Dirty on Clean Architecture</b><br>Tom Hombergs</sub>
      </a>
    </td>
    <td align="center" width="25%">
      <a href="LIEN_AMAZON_OU_MOMOX">
        <img src="COVER_URL" width="120" alt="Hexagonal Architecture Explained"><br>
        <sub><b>Hexagonal Architecture Explained</b><br>A. Cockburn, J. Grey</sub>
      </a>
    </td>
  </tr>
</table>-->
...
- [martinfowler.com](LIEN)
- [Google Engineering Practices](LIEN)
- [The Twelve-Factor App](LIEN)
...
<table>
  <tr>
    <td align="center" width="25%">
      <a href="LIEN_AMAZON_OU_MOMOX">
        <img src="COVER_URL" width="120" alt="Clean Code"><br>
        <sub><b>Clean Code</b><br>Robert C. Martin</sub>
      </a>
    </td>
    <td align="center" width="25%">
      <a href="LIEN_AMAZON_OU_MOMOX">
        <img src="COVER_URL" width="120" alt="The Pragmatic Programmer"><br>
        <sub><b>The Pragmatic Programmer</b><br>Hunt & Thomas</sub>
      </a>
    </td>
    <td align="center" width="25%">
      <a href="LIEN_AMAZON_OU_MOMOX">
        <img src="COVER_URL" width="120" alt="Accelerate"><br>
        <sub><b>Accelerate</b><br>Forsgren, Humble, Kim</sub>
      </a>
    </td>
  </tr>
</table>
